import { IsEmail, IsString, MinLength, MaxLength, IsOptional, IsBoolean, IsEnum, IsUUID, IsDateString } from 'class-validator';
...
export class UsersResponseDto {
  ...
  constructor(users: UserDetailDto[], total: number, page: number, limit: number) {
    this.users = users;
    this.total = total;
    this.page = page;
    this.limit = limit;
