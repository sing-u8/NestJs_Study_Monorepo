...
import { RefreshTokenTypeOrmEntity } from "../auth/infrastructure/database/entity/refresh-token.typeorm.entity";
import { UserTypeOrmEntity } from "../auth/infrastructure/database/entity/user.typeorm.entity";
...
export const databaseConfig = registerAs(
	...
	(): TypeOrmModuleOptions => ({
		...
		// entity: [`${__dirname}/../**/*.typeorm.entity{.ts,.js}`],
		// entity: [RefreshTokenTypeOrmEntity, UserTypeOrmEntity],
		autoLoadEntities: true,

		// 마이그레이션 설정
		// migration: [`${__dirname}/../**/migration/*{.ts,.js}`],
